            ...
            <div class="content">
                <div class="informations">
                    ...
                    <div class="single-info">
                        ...
                        <div class="info">
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#dfffb6b1b9b09fbaa7beb2afb3baf1bcb0b2"><span class="__cf_email__" data-cfemail="533a3d353c13362b323e233f367d303c3e">[email&#160;protected]</span></a>
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#57773e39313817242227273825237934383a"><span class="__cf_email__" data-cfemail="2c45424a436c5f595c5c435e58024f4341">[email&#160;protected]</span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form class="mobile-menu-form">
                    ...
                    <div class="email pt-20 d-flex align-items-center">
                        ...
                        <div class="email-info">
                            <span>Email Now</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#62071a030f120e0722050f030b0e4c010d0f"><span class="__cf_email__" data-cfemail="94f1ecf5f9e4f8f1d4f3f9f5fdf8baf7fbf9">[email&#160;protected]</span></a></h6>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="breadcrumb-wrapper">
                        <div class="breadcrumb-cnt">
                            ...
                            <div class="breadcrumb-list">
                                <a href="{{ url('/') }}">Home</a><img src="{{ asset('assets/img/inner-pages/breadcrumb-arrow.svg') }}" alt=""> Blog Sidebar
                            </div>
            ...
            <div class="row g-lg-4 gy-5">
                <div class="col-lg-8">
                    <div class="row g-lg-4 gy-5">
                        <div class="col-md-6 wow animate fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="single-blog magnetic-item">
                                <div class="blog-img">
                                    ...
                                    <div class="blog-tag">
                                        <a href="{{ url('blog') }}">Web development</a>
                                    </div>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                        <li><a href="{{ url('blog') }}">May 20, 2023</a></li>
                                        <li><a href="{{ url('blog') }}">Comment (3)</a></li>
                                    </ul>
                        ...
                        <div class="col-md-6 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="single-blog magnetic-item">
                                <div class="blog-img">
                                    ...
                                    <div class="blog-tag">
                                        <a href="{{ url('blog') }}">Cloud solutions</a>
                                    </div>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                        ...
                        <div class="col-md-6 wow animate fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="single-blog magnetic-item">
                                <div class="blog-img">
                    ...
                    <div class="widget-area">
                        ...
                        <div class="single-widgets widget_egns_categoris">
                            ...
                            <ul class="wp-block-categoris-cloud">
                                <li><a href="{{ url('blog-grid') }}"><span>Web Design</span> <span class="number-of-categoris">(30)</span></a></li>
                                <li><a href="{{ url('blog-grid') }}"><span>Apps Development</span> <span class="number-of-categoris">(18)</span> </a></li>
                                <li><a href="{{ url('blog-grid') }}"><span>Software Development</span> <span class="number-of-categoris">(21)</span></a></li>
                                <li><a href="{{ url('blog-grid') }}"><span>Motion Graphics</span> <span class="number-of-categoris">(25)</span></a></li>
                                <li><a href="{{ url('blog-grid') }}"><span>UI/UX Design</span> <span class="number-of-categoris">(29)</span></a></li>
                            </ul>
                        </div>
                            ...
                            <div class="recent-post-wraper">
                                <div class="widget-cnt">
                                    ...
                                    <div class="wc">
                                        ...
                                        <a href="{{ url('blog-grid') }}">May 18, 2023</a>
                                    </div>
                                </div>
                                <div class="widget-cnt">
                                    <div class="wi">
                                    ...
                                    <div class="wc">
                                        ...
                                        <a href="{{ url('blog-grid') }}">May 15, 2023</a>
                                    </div>
                                </div>
                                <div class="widget-cnt">
                                    <div class="wi">
                                    ...
                                    <div class="wc">
                                        ...
                                        <a href="{{ url('blog-grid') }}">May 14, 2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="single-widgets widget_egns_tag">
                            ...
                            <p class="wp-block-tag-cloud">
                                <a href="{{ url('blog-grid') }}">Website</a>
                                <a href="{{ url('blog-grid') }}">Web Design</a>
                                <a href="{{ url('blog-grid') }}">Development</a>
                                <a href="{{ url('blog-grid') }}">Graphic Design</a>
                                <a href="{{ url('blog-grid') }}">Graphic</a>
                                <a href="{{ url('blog-grid') }}">UI/UX Design</a>
                                <a href="{{ url('blog-grid') }}">Activities</a>
                                <a href="{{ url('blog-grid') }}">Software Design</a>
                                <a href="{{ url('blog-grid') }}">3D Design</a>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 d-flex">
                    <div class="footer-widget">
                        ...
                        <div class="footer-contact mb-40">
                            ...
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#b9d0dfd6f9dcc1d8d4c9d5dc97dad6d4"><span class="__cf_email__" data-cfemail="3059565f705548515d405c551e535f5d">[email&#160;protected]</span></a><br>
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#c4adaaa2ab84b7b1b4b4abb6b0eaa7aba9"><span class="__cf_email__" data-cfemail="dab3b4bcb59aa9afaaaab5a8aef4b9b5b7">[email&#160;protected]</span></a>
                        </div>
