...
<!-- Mirrored from demo.egenslab.com/html/softconic/preview/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Jan 2026 18:07:52 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <div class="content">
                <div class="informations">
                    ...
                    <div class="single-info">
                        ...
                        <div class="info">
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#89a9e0e7efe6c9ecf1e8e4f9e5eca7eae6e4"><span class="__cf_email__" data-cfemail="d0b9beb6bf90b5a8b1bda0bcb5feb3bfbd">[email&#160;protected]</span></a>
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#dafab3b4bcb59aa9afaaaab5a8aef4b9b5b7"><span class="__cf_email__" data-cfemail="543d3a323b14272124243b26207a373b39">[email&#160;protected]</span></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <form class="mobile-menu-form">
                    ...
                    <div class="email pt-20 d-flex align-items-center">
                        ...
                        <div class="email-info">
                            <span>Email Now</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#67021f060a170b0227000a060e0b4904080a"><span class="__cf_email__" data-cfemail="fe9b869f938e929bbe99939f9792d09d9193">[email&#160;protected]</span></a></h6>
                        </div>
                    </div>
                </form>
                    ...
                    <div class="breadcrumb-wrapper">
                        <div class="breadcrumb-cnt">
                            ...
                            <div class="breadcrumb-list">
                                <a href="{{ url('/') }}">Home</a><img src="{{ asset('assets/img/inner-pages/breadcrumb-arrow.svg') }}" alt=""> Projects Details
                            </div>
            ...
            <div class="row g-4 mb-80">
                <div class="col-lg-7">
                    <div class="portfolio-img magnetic-item">
                        <img class="img-fluid" src="{{ asset('assets/img/inner-pages/portfolio-dt-01.png') }}" alt="">
                    </div>
                </div>
                <div class="col-lg-5">
                    <div class="row g-4">
                        <div class="col-lg-12">
                            <div class="portfolio-img magnetic-item">
                                <img class="img-fluid" src="{{ asset('assets/img/inner-pages/portfolio-dt-02.png') }}" alt="">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="portfolio-img magnetic-item">
                                <img class="img-fluid" src="{{ asset('assets/img/inner-pages/portfolio-dt-03.png') }}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="portfolio-content">
                        ...
                        <div class="row g-4 mb-55">
                            <div class="col-lg-7 col-sm-6">
                                <div class="portfolio-img magnetic-item">
                                    <img class="img-fluid" src="{{ asset('assets/img/inner-pages/portfolio-dt-04.png') }}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-5 col-sm-6">
                                <div class="portfolio-img magnetic-item">
                                    <img class="img-fluid" src="{{ asset('assets/img/inner-pages/portfolio-dt-05.png') }}" alt="">
                                </div>
                            </div>
                        </div>
                        <h3>Result</h3>
                ...
                <div class="col-lg-12">
                    <div class="details-navigation">
                        <div class="single-navigation">
                            <div class="content">
                                <a href="{{ url('project-details') }}">Previous</a>
                                <h4><a href="{{ url('project-details') }}">Streamlining IT Infrastructure</a></h4>
                            </div>
                            <a href="{{ url('project-details') }}" class="img">
                                <img src="{{ asset('assets/img/inner-pages/portfolio-navigation-01.png') }}" alt="">
                                <div class="arrow">
                        ...
                        <div class="single-navigation two">
                            <a href="{{ url('project-details') }}" class="img">
                                <img src="{{ asset('assets/img/inner-pages/portfolio-navigation-02.png') }}" alt="">
                                <div class="arrow">
                                    <svg width="12" height="12" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0 1H12M12 1V13M12 1L0.5 12"></path>
                                    </svg>
                            ...
                            <div class="content">
                                <a href="{{ url('project-details') }}">NEXT </a>
                                <h4><a href="{{ url('project-details') }}">Scaling Agile Development</a></h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-sm-6 d-flex">
                    <div class="footer-widget">
                        ...
                        <div class="footer-contact mb-40">
                            ...
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#7118171e311409101c011d145f121e1c"><span class="__cf_email__" data-cfemail="b2dbd4ddf2d7cad3dfc2ded79cd1dddf">[email&#160;protected]</span></a><br>
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#7c15121a133c0f090c0c130e08521f1311"><span class="__cf_email__" data-cfemail="fb92959d94bb888e8b8b94898fd5989496">[email&#160;protected]</span></a>
                        </div>
...
<!-- Mirrored from demo.egenslab.com/html/softconic/preview/project-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Jan 2026 18:07:56 GMT -->
</html>
