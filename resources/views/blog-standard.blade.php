...
<!-- Mirrored from demo.egenslab.com/html/softconic/preview/blog-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Jan 2026 18:08:04 GMT -->
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<body class="home-dark2 tt-magic-cursor">
    ...
    <div class="header-sidebar">
        <div class="siderbar-top">
            <div class="sidebar-log">
                <a href="{{ url('/') }}"><img src="{{ asset('assets/img/logo.svg') }}" alt=""></a>
            </div>
            <div class="close-btn">
            ...
            <div class="content">
                <div class="informations">
                    ...
                    <div class="single-info">
                        ...
                        <div class="info">
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#4c6c25222a230c29342d213c2029622f2321"><span class="__cf_email__" data-cfemail="3851565e57785d40595548545d165b5755">[email&#160;protected]</span></a>
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#17377e79717857646267677865633974787a"><span class="__cf_email__" data-cfemail="afc6c1c9c0efdcdadfdfc0dddb81ccc0c2">[email&#160;protected]</span></a>
                        </div>
                    </div>
                </div>
            </div>
            <!-- <img src="{{ asset('assets/images/bg/office1.png') }}" alt="image"> -->
        </div>
    ...
    <header class="header-area2">
        <div class="header-logo">
            <a href="{{ url('/') }}"><img alt="image" class="img-fluid" src="{{ asset('assets/img/logo.svg') }}"></a>
        </div>
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="{{ url('/') }}"><img alt="image" src="{{ asset('assets/img/logo.svg') }}"></a>
                </div>
            </div>
            <ul class="menu-list">
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="{{ url('index4') }}">Home 04</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li><a href="{{ url('service') }}">Service 01</a></li>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="{{ url('team1') }}">Team</a>
                            <i class="d-lg-flex d-none bi bi-chevron-right dropdown-icon"></i>
                            <i class="d-lg-none d-flex bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <li><a href="{{ url('team1') }}">Team 01</a></li>
                                <li><a href="{{ url('team2') }}">Team 02</a></li>
                                <li><a href="{{ url('team3') }}">Team 03</a></li>
                            </ul>
                        </li>
                        <li>
                           <a href="{{ url('pricing') }}">Pricing</a>
                            ...
                            <i class="d-lg-none d-flex bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <li><a href="{{ url('pricing') }}">Pricing 01</a></li>
                                <li><a href="{{ url('pricing2') }}">Pricing 02</a></li>
                            </ul>
                        </li>
                ...
                <li class="menu-item-has-children">
                    ...
                    <ul class="sub-menu">
                        <li><a href="{{ url('case-study') }}">Case study 01</a></li>
                        <li><a href="{{ url('case-study2') }}">Case study 02</a></li>
                        <li><a href="{{ url('case-study-standard') }}">Case study standard</a></li>
                        <li><a href="{{ url('case-study-details') }}">Case study Details</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children active">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="{{ url('blog-masonary') }}">Blog Masonary</a></li>
                ...
                <form class="mobile-menu-form">
                    ...
                    <div class="email pt-20 d-flex align-items-center">
                        ...
                        <div class="email-info">
                            <span>Email Now</span>
                            <h6><a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#2b4e534a465b474e6b4c464a424705484446"><span class="__cf_email__" data-cfemail="2b4e534a465b474e6b4c464a424705484446">[email&#160;protected]</span></a></h6>
                        </div>
                    </div>
                </form>
                <div class="header-btn5">
                    <a class="primary-btn3" href="{{ url('contact') }}">Get A Quote</a>
                </div>
            </div>
        </div>
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            <div class="sidebar-btn2">
                <img src="{{ asset('assets/img/home-3/sidebar-btn.svg') }}" alt="">
            </div>
                    ...
                    <div class="breadcrumb-wrapper">
                        <div class="breadcrumb-cnt">
                            ...
                            <div class="breadcrumb-list">
                                <a href="{{ url('/') }}">Home</a><img src="{{ asset('assets/img/inner-pages/breadcrumb-arrow.svg') }}" alt=""> Blog Standard
                            </div>
                    ...
                    <div class="row g-lg-4 gy-5">
                        <div class="col-md-12 wow animate fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="single-blog magnetic-item">
                                <div class="blog-img">
                                    <img class="img-fluid" src="{{ asset('assets/img/inner-pages/blog-standard-01.png') }}" alt="">
                                    <div class="blog-tag">
                                        <a href="{{ url('blog-standard') }}">Web development</a>
                                    </div>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                        <li><a href="{{ url('blog-standard') }}">May 20, 2023</a></li>
                                        <li><a href="{{ url('blog-standard') }}">Comment (3)</a></li>
                                    </ul>
                                    <h4><a href="{{ url('blog-details') }}">Donec finibus laoreet exte eu pellentesque. </a></h4>
                                    ...
                                    <div class="blog-footer">
                                        <div class="read-btn">
                                            <a href="{{ url('blog-details') }}">Read More
                                                <svg width="12" height="12" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0 1H12M12 1V13M12 1L0.5 12"></path>
                                                </svg>
                                            </a>
                        ...
                        <div class="col-md-12 wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
                            <div class="single-blog magnetic-item">
                                <div class="blog-img">
                                    <img class="img-fluid" src="{{ asset('assets/img/inner-pages/blog-standard-02.png') }}" alt="">
                                    <div class="blog-tag">
                                        <a href="{{ url('blog-standard') }}">Cloud solutions</a>
                                    </div>
                                </div>
                                <div class="blog-content">
                                    <ul class="blog-meta">
                                    ...
                                    <h4><a href="{{ url('blog-details') }}">feugiat varius mattis mass enim est egestas.</a></h4>
                                    <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh elementum, accumsan ona
                                        neque ac, aliquet nunc. In eu ipsum fringilla.</p>
                                    <div class="blog-footer">
                                        <div class="read-btn">
                        ...
                        <div class="col-md-12 wow animate fadeInRight" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="single-blog magnetic-item">
                                <div class="blog-img">
                                    <img class="img-fluid" src="{{ asset('assets/img/inner-pages/blog-standard-03.png') }}" alt="">
                                    <div class="blog-tag">
                                        <a href="{{ url('blog-standard') }}">Web development</a>
                                    </div>
                                </div>
                                <div class="blog-content">
                                    ...
                                    <h4><a href="{{ url('blog-details') }}">Navigating the Journey off Cloud Solution.</a></h4>
                                    <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Etiam eu nibh elementum, accumsan ona
                                        neque ac, aliquet nunc. In eu ipsum fringilla.</p>
                                    <div class="blog-footer">
                                        <div class="read-btn">
                        ...
                        <div class="col-md-12 wow animate fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="single-blog magnetic-item">
                                <div class="blog-img">
                                    <img class="img-fluid" src="{{ asset('assets/img/inner-pages/blog-standard-04.png') }}" alt="">
                                    <div class="blog-tag">
                                        <a href="{{ url('blog-standard') }}">Web development</a>
                                    </div>
                                </div>
                    ...
                    <div class="widget-area">
                        ...
                        <div class="single-widgets widget_egns_categoris">
                            ...
                            <ul class="wp-block-categoris-cloud">
                                <li><a href="{{ url('blog') }}"><span>Web Design</span> <span class="number-of-categoris">(30)</span></a></li>
                                <li><a href="{{ url('blog') }}"><span>Apps Development</span> <span class="number-of-categoris">(18)</span> </a></li>
                                <li><a href="{{ url('blog') }}"><span>Software Development</span> <span class="number-of-categoris">(21)</span></a></li>
                                <li><a href="{{ url('blog') }}"><span>Motion Graphics</span> <span class="number-of-categoris">(25)</span></a></li>
                                <li><a href="{{ url('blog') }}"><span>UI/UX Design</span> <span class="number-of-categoris">(29)</span></a></li>
                            </ul>
                        </div>
                        <div class="single-widgets widget_egns_recent_post">
                            ...
                            <div class="recent-post-wraper">
                                <div class="widget-cnt">
                                    <div class="wi">
                                        <a href="{{ url('blog-details') }}"><img src="{{ asset('assets/img/inner-pages/blog-sidebar-1.png') }}" alt="image"></a>
                                    </div>
                                    <div class="wc">
                                        <h6><a href="{{ url('blog-details') }}">Grant Distributions Conti nu to Incr Ease.</a></h6>
                                        <a href="{{ url('blog') }}">May 18, 2023</a>
                                    </div>
                                </div>
                                <div class="widget-cnt">
                                    <div class="wi">
                                        <a href="{{ url('blog-details') }}"><img src="{{ asset('assets/img/inner-pages/blog-sidebar-2.png') }}" alt="image"></a>
                                    </div>
                                    <div class="wc">
                                        <h6><a href="{{ url('blog-details') }}">Distributions Conti nu to grant Incr Ease.</a></h6>
                                        <a href="{{ url('blog') }}">May 15, 2023</a>
                                    </div>
                                </div>
                                <div class="widget-cnt">
                                    <div class="wi">
                                        <a href="{{ url('blog-details') }}"><img src="{{ asset('assets/img/inner-pages/blog-sidebar-3.png') }}" alt="image"></a>
                                    </div>
                                    <div class="wc">
                                        <h6><a href="{{ url('blog-details') }}">Conti nu to Incr Ease malesuada sapien sed.</a></h6>
                                        <a href="{{ url('blog') }}">May 14, 2023</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="single-widgets widget_egns_tag">
                            ...
                            <p class="wp-block-tag-cloud">
                                <a href="{{ url('blog') }}">Website</a>
                                <a href="{{ url('blog') }}">Web Design</a>
                                <a href="{{ url('blog') }}">Development</a>
                                <a href="{{ url('blog') }}">Graphic Design</a>
                                <a href="{{ url('blog') }}">Graphic</a>
                                <a href="{{ url('blog') }}">UI/UX Design</a>
                                <a href="{{ url('blog') }}">Activities</a>
                                <a href="{{ url('blog') }}">Software Design</a>
                                <a href="{{ url('blog') }}">3D Design</a>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="footer-top-content">
                            <div class="footer-logo">
                                <a href="{{ url('/') }}"><img class="img-fluid" src="{{ asset('assets/img/logo.svg') }}" alt=""></a>
                            </div>
                ...
                <div class="col-lg-4 col-sm-6 d-flex">
                    <div class="footer-widget">
                        ...
                        <div class="footer-contact mb-40">
                            ...
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#b0d9d6dff0d5c8d1ddc0dcd59ed3dfdd"><span class="__cf_email__" data-cfemail="d4bdb2bb94b1acb5b9a4b8b1fab7bbb9">[email&#160;protected]</span></a><br>
                            <a href="https://demo.egenslab.com/cdn-cgi/l/email-protection#523b3c343d12212722223d20267c313d3f"><span class="__cf_email__" data-cfemail="7b12151d143b080e0b0b14090f55181416">[email&#160;protected]</span></a>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
                    <div class="footer-widget">
                        ...
                        <div class="menu-container">
                            <ul>
                                <li><a href="{{ url('service') }}">Web Development</a></li>
                                <li><a href="{{ url('service') }}">Mobile Development</a></li>
                                <li><a href="{{ url('service') }}">Cloud Services</a></li>
                                <li><a href="{{ url('service') }}">Network Connectivity</a></li>
                                <li><a href="{{ url('service') }}">Data analytics</a></li>
                                <li><a href="{{ url('service') }}">Software Development</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="footer-widget">
                        ...
                        <div class="menu-container">
                            <ul>
                                ...
                                <li><a href="{{ url('blog') }}">News & Article</a></li>
                                <li><a href="{{ url('team1') }}">Our Team</a></li>
                                <li><a href="{{ url('project') }}">All Portfolio</a></li>
...
<!-- Mirrored from demo.egenslab.com/html/softconic/preview/blog-standard.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 31 Jan 2026 18:08:07 GMT -->
</html>
