...
@section('title', 'About Us - Nerdtech Labs')
                    ...
                    <div class="single-blog magnetic-item">
                        ...
                        <div class="blog-content">
                           <ul class="blog-meta">
                            ...
                            <h4><a href="{{ route('blog-details') }}">feugiat varius mattis mass enim est egestas.</a></h4>
                            <div class="blog-footer">
                                <div class="read-btn">
                                    <a href="{{ route('blog-details') }}">Read More
                                        <svg width="12" height="12" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="single-blog magnetic-item">
                        ...
                        <div class="blog-content">
                           <ul class="blog-meta">
                            ...
                            <h4><a href="{{ route('blog-details') }}">Navigating the Journey off Cloud Solution.</a></h4>
                            <div class="blog-footer">
                                <div class="read-btn">
                                    <a href="{{ route('blog-details') }}">Read More
                                        <svg width="12" height="12" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
